...
5. **Оформите Pull Request**
    ...
    - если это новая статья, оформите ее как те, что уже есть. Например: https://github.com/zheleznikov/WebDev-Handbook/blob/master/src/content/notes/sync_async.md
